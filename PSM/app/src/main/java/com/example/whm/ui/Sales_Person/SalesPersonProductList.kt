            ...
            { response->
                ...
                if (responseCode=="201")
                {
                   ...
                   for (i in 0 until responseResultData.length())
                   {
                       ...
                       addProductdataModelClass(PId,PName,ImageUrl,CStock,BP,UnitType,0,"","",0.2f,0)
                   }
...
try {
    ...
    override fun OnItemClick(position: Int) {
        val ClickedItem:SalesPersonProductModel=productListModelClass[position]
                        ...
                        if (responseCode == "201") {
                          var  responseResultData = responsedData.getJSONArray("responseData")
                            ...
                            if (responseResultData.length() != null && responseResultData.length() > 0) {
                                ...
                                var adapter = ArrayAdapter<String>(this, R.layout.support_simple_spinner_dropdown_item, mylist)
            ...
            Picasso.get().load(ClickedItem.getImageUrl()).error(R.drawable.default_pic).into(imageView13);
...
//                                        Log.e("message",responseMessage1.toString())
    ...
    {
        var productModelClass = SalesPersonProductModel(PId,PName, ImageUrl,CStock,BP,UnitType,OQty,UnitPrice,Total,NofItem,draftAutoId)
