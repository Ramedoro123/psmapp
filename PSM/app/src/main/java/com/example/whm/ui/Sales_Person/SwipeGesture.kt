package com.example.myapplication.com.example.whm.ui.Sales_Person
...
abstract class SwipeGesture(context: Context):ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
    ...
    val GreenColor =ContextCompat.getColor(context,R.color.holo_green_dark)
    ...
    override fun onChildDraw(
        ...
        RecyclerViewSwipeDecorator.Builder(c,
            ...
            .addSwipeRightBackgroundColor(GreenColor)
            .create()
            .decorate()
